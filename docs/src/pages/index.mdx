...
* full stack from 8-bit MCU to web development
...
## Web-friendly tooling

We've implemented Jacdac over **WebUSB**, which allows the Jacdac bus to reach into
the web browser sandbox. This web page features a [dashboard](/dashboard) for displaying
both physical and virtual Jacdac devices, as well as a set of [tools](/tools) for
working with Jacdac devices. 
