---
hideToc: true
title: Device Models Repository
---

# Device Models Repository

This route hosts [DTDL](https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/dtdlv2.md) models for each [service](/services),
similar to https://devicemodels.azure.com/.
