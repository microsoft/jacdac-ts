...
The base class of all elements in the [JDOM](/clients/web/jdom).
...
All these elements are [nodes](/clients/web/jdom/node) in the [JDOM](/clients/web/jdom).

The node is globally uniquely identifiable in the JDOM,
