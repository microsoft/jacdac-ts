...
that has [registers](/clients/web/dom/register), [events](/clients/web/dom/event), accept **commands**
...
This function returns an [event](/clients/web/dom/event) object mapped at a given address.
