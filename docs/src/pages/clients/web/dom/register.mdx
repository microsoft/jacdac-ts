...
> A **register** is a [DOM](/clients/web/dom) [node](/clients/web/dom/node) that represents an addressed data location
...
[Device](/clients/web/dom/device), [Service](/clients/web/dom/service), [Event](/clients/web/dom/event)