...
import { serviceSpecificationFromName, deviceSpecificationFromClassIdenfitier } from "../../../../src/dom/spec"
...
<pre>
    <code className="language-markdown">{deviceSpecificationFromClassIdenfitier(0x30838b8e).source}</code>
</pre>
